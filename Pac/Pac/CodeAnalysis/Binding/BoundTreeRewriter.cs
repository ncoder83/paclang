...
namespace PacLang.Binding
{
    internal abstract class BoundTreeRewriter
    {
        ...
        public virtual BoundStatement RewriteStatement(BoundStatement node)
        {
            switch (node.Kind)
            {
                ...
                case BoundNodeKind.VariableDeclaration:
                    return RewriteVariableStatement((BoundVariableDeclaration)node);
        ...
        protected virtual BoundStatement RewriteVariableStatement(BoundVariableDeclaration node)
        {
        ...
        public virtual BoundExpression RewriteExpression(BoundExpression node)
        {
            switch (node.Kind)
            {
                ...
                case BoundNodeKind.AssigmentExpression:
                    return RewriteAssigmentExpression((BoundAssignmentExpression)node);
        ...
        protected virtual BoundExpression RewriteAssigmentExpression(BoundAssignmentExpression node)
        {
